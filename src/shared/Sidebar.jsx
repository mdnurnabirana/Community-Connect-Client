...
const userNav = [
  ...
  { name: "My Events", path: "/dashboard/my-events", icon: <FaHome />},
  { name: "My Payments", path: "/dashboard/my-payments", icon: <FaHome />},
];
...
const managerNav = [
  ...
  { name: "Create Event", path: "/dashboard/create-event", icon: <FaHome />},
  { name: "Manage Event", path: "/dashboard/manage-event", icon: <FaHome />},
];
